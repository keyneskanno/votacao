...
class __TwigTemplate_d4133a427ab21567ecbc52b8fe115635 extends Template
{
    private $source;
    private $macros = [];
...
<ol>
  ...
  <li>{% trans %}Click <em>Save configuration</em>. You should see a message indicating that the settings were saved.{% endtrans %}</li>
</ol>", "@help_topics/system.config_error.html.twig", "/var/www/votacao/web/core/modules/system/help_topics/system.config_error.html.twig");
    }
