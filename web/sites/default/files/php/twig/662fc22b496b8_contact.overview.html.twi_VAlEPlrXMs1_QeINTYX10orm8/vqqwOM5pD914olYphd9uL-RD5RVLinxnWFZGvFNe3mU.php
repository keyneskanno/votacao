...
class __TwigTemplate_e97d94059fc64f8667bd42a8707385af extends Template
{
    private $source;
    private $macros = [];
...
<p>{% trans %}See the related topics below for specific tasks.{% endtrans %}</p>", "@help_topics/contact.overview.html.twig", "/var/www/votacao/web/core/modules/contact/help_topics/contact.overview.html.twig");
    }
