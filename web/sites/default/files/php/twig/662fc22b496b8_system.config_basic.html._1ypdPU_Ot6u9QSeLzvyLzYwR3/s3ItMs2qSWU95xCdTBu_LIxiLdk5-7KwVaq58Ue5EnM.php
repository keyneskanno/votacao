...
class __TwigTemplate_7b5119fc1f98777a75561cdd4b91e00b extends Template
{
    private $source;
    private $macros = [];
...
<p>{% trans %}<a href=\"https://www.php.net/manual/datetime.format.php#refsect1-datetime.format-parameters\">PHP date format codes reference</a>{% endtrans %}</p>", "@help_topics/system.config_basic.html.twig", "/var/www/votacao/web/core/modules/system/help_topics/system.config_basic.html.twig");
    }
